...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({user:e})=>$.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>{const{name:t,email:i,body:n}=e;return $.jsxs("div",{className:"CommentInfo",children:[$.jsx("div",{className:"CommentInfo__name",children:t}),$.jsx("a",{className:"CommentInfo__email",href:`mailto:${i}`,children:i}),$.jsx("p",{className:"CommentInfo__body",children:n})]})},Tc=({comments:e})=>$.jsx("div",{className:"CommentList",children:e.map(t=>$.jsx(Lc,{comment:t},t.id))}),Mc=({post:e})=>{const{title:t,body:i,user:n,comments:a}=e;return $.jsxs("div",{className:"PostInfo",children:[$.jsx("h2",{className:"PostInfo__title",children:t}),$.jsx("p",{className:"PostInfo__body",children:i}),n&&$.jsx(Pc,{user:n}),a.length>0?$.jsx(Tc,{comments:a}):$.jsx("p",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})},Rc=({posts:e})=>$.jsx("div",{className:"PostList",children:e.map(t=>$.jsx(Mc,{post:t},t.id))}),Dc=zc.map(e=>({...e,user:Cc.find(t=>t.id===e.userId)||null,comments:Nc.filter(t=>t.postId===e.id)})),jc=()=>$.jsxs("div",{className:"App",children:[$.jsx("h1",{children:"Static list of posts"}),$.jsx(Rc,{posts:Dc})]}),Oc=em(document.getElementById("root"));Oc.render($.jsx(jc,{}));
